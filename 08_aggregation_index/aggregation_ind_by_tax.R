...
coor_s <- c %>% mutate(long = long+i*2e-6+j*2e-7, lat = lat+i*2e-6+j*2e-7) 
...
pdf("Author_response_fig1a_ori_sampling_space.pdf", height=5, width=8)
par(mar=c(1,1,1,1))
plot(coor_s$long, coor_s$lat, xlim=c(9, 10), ylim=c(47.4, 47.9), xaxt='n',yaxt='n', bty = 'n', ann=F)
polygon(x=c(9.03465, 9.18026,	9.19743,	9.23384,	9.25991,	9.33528,	9.32038,	9.37610,
            9.41080,	9.47531,	9.42772,	9.48473,	9.61523,	9.6798,	9.75123,	9.71826,
            9.62828,	9.59875,	9.53968,	9.48885,	9.41261,	9.34049,	9.06292),
        y=c(47.80435,	47.72905,	47.64855,	47.63250,	47.64715,	47.62857,	47.59713,	47.57352,
            47.61780,	47.5546,	47.52606,	47.48707,	47.53488,	47.50239,	47.50889,	47.55112,
